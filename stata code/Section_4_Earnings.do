...
*******************************************************************************/
	...
	*****************************************/
	...
	//A student may be marked as working, but be missing annual wages. This would be due to our imputation and reporting procedure. 
	//We only report wages for students who worked at least 3 quarters of a given year. As such, if a student only worked 1 quarter 
	//they will have a "yes" for working, but missing wages.
	...
	*wages 
		label variable ADJ_ANNUAL_WAGES "Adjusted Annual Wages"
